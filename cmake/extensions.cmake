...
macro(ameba_soc_library name)
    ...
    if(TARGET target_bootloader)
      add_dependencies(target_bootloader ${CURRENT_LIB_NAME}_postbuild)
    endif()

    if(TARGET target_flashloader)
      add_dependencies(target_flashloader ${CURRENT_LIB_NAME}_postbuild)
    endif()

    if(TARGET target_imgtool_flashloader)
      add_dependencies(target_imgtool_flashloader ${CURRENT_LIB_NAME}_postbuild)
    endif()

    if(TARGET target_img2_${PROJECT_NAME})
      add_dependencies(target_img2_${PROJECT_NAME} ${CURRENT_LIB_NAME}_postbuild)
    endif()

    if(TARGET target_img3)
      add_dependencies(target_img3 ${CURRENT_LIB_NAME}_postbuild)
    endif()
